use rsbt_bencode::{RsbtBencodeError, Torrent, TorrentInfoFile};

use std::convert::TryInto;
use std::path::PathBuf;

#[test]
fn parse_plan_9_torrent() -> Result<(), RsbtBencodeError> {
...
#[test]
fn parse_ferris_torrent() -> Result<(), RsbtBencodeError> {
